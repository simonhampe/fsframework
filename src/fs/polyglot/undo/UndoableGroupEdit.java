...
/**
 * This edit represents a group change, i.e. changing a group name. This will automatically change the group attribute of all strings in this group
 * to the new group attribute. null is also allowed as new group attribute, this will 'move' all strings in the concerned group to the root group
 * @author Simon Hampe
 *
 */
public class UndoableGroupEdit extends AbstractUndoableEdit {
	 ...
	 */
	public UndoableGroupEdit(String oldValue, String newValue, PolyglotTableModel table, PolyglotStringLoader loader, String languageID) {
	...
	/**
	 * @return Always true (though the actual edit might have no effect, if there is no string in the group concerned (hence it doesn't exist)
	 */
	@Override
	 ...
	 */
	public String getLanguageEditPresentationName(String oldValue2, String newValue2) {
	...
	/**
	 * Convenience method which changes a group oldval to newval in the specified table, i.e. does the following: All strings that are in 
	 * group oldval are moved to group newval.
	 * @param table The table in which the change should be effected (If null, then this call has no effect)
	 * @param oldValue The old value. 
	 * @param newValue The new value. 
	 * @throws UnsupportedOperationException - If this operation cannot be performed (never thrown)
	 */
	public static void performLanguageEdit(PolyglotTableModel table, String oldValue, String newValue) throws UnsupportedOperationException {
		if(table == null || (oldValue == null && newValue == null)) return;
