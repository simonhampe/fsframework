...
/**
 * This implements a tree view of the group structure of a polyglot string table. In addition to the actual tree view there are
...
public class GroupTreeView extends JPanel implements ResourceDependent{
	...
	/**
	 * Creates a group tree view (a tree only displaying the string groups of a PolyglotStringTable). This
	 * will register itself automatically to the {@link TableUndoManager} associated to the specified table.
	 * @param r The resource reference for icons and such. If null, the default reference is used
	 * @param stringloader The string loader for tooltips and such. If null, the default loader is used
	 * @param languageID The language for tooltips and such. If null, the global language id is used
	 * @param associatedTable The table whose data should be displayed. If null, an empty table is used
	 */
	public GroupTreeView(ResourceReference r, PolyglotStringLoader stringloader, String languageID, PolyglotTableModel associatedTable) {
		//Copy data
		super();
		assignReference(r);
		...
		treerenderer = new GroupTreeCellRenderer(reference,loader, this.languageID,true);
		...
		deleteButton.setToolTipText(loader.getString(sgroup + ".delete",this.languageID));
		editButton.setIcon(editIcon);
		editButton.setToolTipText(loader.getString(sgroup + ".edit", this.languageID));
		...
		//Event handling
		grouptree.getSelectionModel().addTreeSelectionListener(selectionListener);
	...
	public void assignReference(ResourceReference r) {
		...
		deleteIcon = new ImageIcon(reference.getFullResourcePath(this, "graphics/GroupTreeView/delete.png"));
		editIcon = new ImageIcon(reference.getFullResourcePath(this, "graphics/GroupTreeView/edit.png"));
	}
	...
	public Document getExpectedResourceStructure() {
		XMLDirectoryTree tree = (XMLDirectoryTree) treerenderer.getExpectedResourceStructure();
