...
/**
 * Constructs a label which can be used by CellRenderer classes. This class is designed to unify color
 * schemes of different renderers
 * @author Simon Hampe
 *
 */
public class RendererLabel extends JLabel {
	...
	//Colors
	/**
	 * The background color of a standard label, not selected (white) and
	 * of the border of a label which is not Selected and doesn't have focus
	 */
	...
	/**
	 * The background and border color of a selected label (which doesn't have focus) 
	 */
	...
	public RendererLabel(boolean isSelected, boolean cellHasFocus) {
		...
		setBorder(BorderFactory.createLineBorder(isSelected? 
			(cellHasFocus? selectedBorder :selectedBkg ):
			normalBkg));
	}
