...
/**
 * Implements an extension of DefaultDocument which contains some 
 * convenient methods to create an XML document representing a 
 * file/directory hierarchy, such as accessing nodes via filepaths.  
 * @author Simon Hampe
 *
 */
...
public class XMLDirectoryTree extends DefaultDocument {
	...
	/**
	 * Constructs a DefaultDocument which contains
	 * a root node with the specified name
	 */
	 ...
	 * corresponds to the first part, the last to the last part.
	 * Will return null for a null string.
	 */
	...
	/**
	 * The argument path is interpreted as being a file path 
	 * relative to the root element (if no root element is present,
	 * it will be created as being the root directory (i.e. "").
	 * No double entries will be created, i.e. if a part of this path
	 * already exists, it will be created within that path.
	 */
	...
	/**
	 * This will remove the node corresponding to the last
	 * part of the filename path and all its subnodes. If the node
	 * does not exist, this call is ignored.
	 */
