...
/**
 * A singleton class used to retrieve file paths to resources
 * of fsframework. The user can set the fsframework base path.
 * @author Simon Hampe
 *
 */
public class FsfwDefaultReference implements ResourceReference {
	...
	/**
	 * The base directory of the fsframework used by the application.
	 * By default it is assumed to be the working directory
	 */
	...
	/**
	 * Sets the base path of the <i>global</i> reference for
	 * fsframework. A null string is interpreted as the 
	 * empty string. 
	 */
