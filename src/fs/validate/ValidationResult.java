 ...
 * contains an enum value indicating the overall result and a table mapping
 * registered components to individual results.
 * 
 * @author Simon Hampe
 * 
 */
public class ValidationResult {
	...
	/**
	 * Creates a ValidationResult representing a validation run on a
	 * ComponentValidator.
	 * 
	 * @param overallResult
	 *            The overall result
	 * @param results
	 *            A table with individual results of all registered components.
	 *            May be null. In that case it will internally be set to the
	 *            empty table.
	 */
