...
/**
 * This class represents the basic functionality of the model
 * of a log history window. It is basically an org.apache.log4j.Appender and
 * implements as well a basic change listener mechanism that can be set to
 * action via notifyChangeListeners(), for example, when a new message has been appended.
 * Each class extending this class must implement the method getLogHistory(), which
 * provides an ordered list of all formatted messages that have been appended together
 * with their respective logging level, and several filter control methods.
 * @author Simon Hampe
 *
 */
public abstract class AbstractLogHistoryModel extends AppenderSkeleton implements LogHistoryModel {
	...
	/* (non-Javadoc)
	 * @see fs.log.LogHistoryModel#addChangeListener(javax.swing.event.ChangeListener)
	 */
	...
	/* (non-Javadoc)
	 * @see fs.log.LogHistoryModel#removeChangeListener(javax.swing.event.ChangeListener)
	 */
