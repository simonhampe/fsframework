		...
		try {
			...
			ResourceDependent rd1 = new ResourceDependent() {
				...
				public Document getExpectedResourceStructure() {
					Document d = null;
					try {
						d = XMLToolbox.loadXMLFile(new File("stuff/resdep1.xml"));
					}
					catch(Exception e) {
			...
			ResourceDependent rd2 = new ResourceDependent() {
				...
				public Document getExpectedResourceStructure() {
					Document d = null;
					try {
						d = XMLToolbox.loadXMLFile(new File("stuff/resdep2.xml"));
					}
					catch(Exception e) {
						System.out.println(e.getMessage());
					}
			...
			ResourceDependent rd3 = new ResourceDependent() {
				...
				public Document getExpectedResourceStructure() {
					Document d = null;
					try {
						d = XMLToolbox.loadXMLFile(new File("stuff/resdep3.xml"));
					}
					catch(Exception e) {
						System.out.println(e.getMessage());
					}
